...
function pemesanan() {
  ...
  <h3 style = "padding:0;">Duit yang harus disiapkan :${total.toLocaleString()}
   <button><a href="https://wa.me/6281280866824?text=HaloMin%20saya%20Memesan%20Ricebowl" style = "text-decoration:none; height:40px; width:80px;">Pesan Via WhatsApp!</a></button>`   
} 